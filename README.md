...
Observers logged more than 100 complaints regarding blocked train crossings in Nash County since 2019. Most instances involved stationary trains along CSX-owned railroads blocking crossings from anywhere between 0-15 minutes to, in one reported instance, 6-12 hours. 

More than 80 of the logged instances occurred along a Tarboro Road crossing in Rocky Mount. But most instances that occurred in the county appeared to sit along a single rail line on the Nash-Wilson-Edgecombe county borders. 
...
In complaints logged in the Blocked Crossing Incident Reporter database specific to Nash County, one observer commented: "School buses could not get to students". 
